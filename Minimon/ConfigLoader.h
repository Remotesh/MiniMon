...
public:
	...
	void loadFile(char* file)
	{
		...
		if (configFile.is_open())
		{
			while (std::getline(configFile, line))
			{
				...
				if (config == "moveUp")
					rebind(key, keyCommandActions::moveUp);
				else if (config == "moveLeft")
					rebind(key, keyCommandActions::moveLeft);
				else if (config == "moveDown")
					rebind(key, keyCommandActions::moveDown);
				else if (config == "moveRight")
					rebind(key, keyCommandActions::moveRight);
				else if (config == "inventory")
					rebind(key, keyCommandActions::inventory);
				else if (config == "pause")
					rebind(key, keyCommandActions::pause);
				else if (config == "actionOne")
					rebind(key, keyCommandActions::actionOne);
				else if (config == "actionTwo")
					rebind(key, keyCommandActions::actionTwo);
				else if (config == "actionThree")
					rebind(key, keyCommandActions::actionThree);
				else if (config == "actionFour")
					rebind(key, keyCommandActions::actionFour);
				else if (config == "actionFive")
					rebind(key, keyCommandActions::actionFive);
				else if (config == "modOne")
					rebind(key, keyCommandActions::modOne);
				else if (config == "modTwo")
					rebind(key, keyCommandActions::modTwo);
				else if (config == "modThree")
					rebind(key, keyCommandActions::modThree);
			}
		}
		else
		{
	...
	int processInput(sf::Keyboard::Key keyPressed, bool pressed)
	{
		int command = -1;
